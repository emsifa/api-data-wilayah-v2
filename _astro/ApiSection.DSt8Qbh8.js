...
}`},{method:`GET`,path:`/districts/{regency_id}.json`,description:`Daftar kecamatan di kab/kota tertentu — ringkas id + nama aja (level 3)`,curl:`curl ${h}/districts/32.73.json`,snippets:{curl:`curl ${h}/districts/32.73.json`,fetch:`const res = await fetch("${h}/districts/32.73.json");
const { data, meta } = await res.json();`,axios:`const { data: { data, meta } } = await axios.get(
...
}`},{method:`GET`,path:`/districts/{district_id}.json`,description:`Detail satu kecamatan — plus tau dia dari provinsi & kab/kota mana (level 3)`,curl:`curl ${h}/districts/32.73.01.json`,snippets:{curl:`curl ${h}/districts/32.73.01.json`,fetch:`const res = await fetch("${h}/districts/32.73.01.json");
const { data, meta } = await res.json();`,axios:`const { data: { data, meta } } = await axios.get(
...
}`},{method:`GET`,path:`/villages/{district_id}.json`,description:`Daftar kelurahan/desa di kecamatan itu — udah include kode pos (level 4)`,curl:`curl ${h}/villages/32.73.01.json`,snippets:{curl:`curl ${h}/villages/32.73.01.json`,fetch:`const res = await fetch("${h}/villages/32.73.01.json");
const { data, meta } = await res.json();`,axios:`const { data: { data, meta } } = await axios.get(
...
}`},{method:`GET`,path:`/villages/{village_id}.json`,description:`Detail satu kelurahan/desa — lengkap kode pos + provinsi, kab/kota, kecamatan (level 4)`,curl:`curl ${h}/villages/32.73.01.1001.json`,snippets:{curl:`curl ${h}/villages/32.73.01.1001.json`,fetch:`const res = await fetch("${h}/villages/32.73.01.1001.json");
const { data, meta } = await res.json();`,axios:`const { data: { data, meta } } = await axios.get(
...
}`},{method:`GET`,path:`/postal-codes/{postal_id}.json`,description:`Cari kelurahan by kode pos — misal 40152 tuh daerah mana aja (level 4)`,curl:`curl ${h}/postal-codes/40152.json`,snippets:{curl:`curl ${h}/postal-codes/40152.json`,fetch:`const res = await fetch("${h}/postal-codes/40152.json");
const { data, meta } = await res.json();`,axios:`const { data: { data, meta } } = await axios.get(
...
}`},{method:`GET`,path:`/paths/{province_or_regency_id}.json`,description:`Butuh polygon buat peta? Ambil garis batas provinsi/kab-kota di sini (compact JSON)`,curl:`curl ${h}/paths/32.json`,snippets:{curl:`curl ${h}/paths/32.json`,fetch:`const res = await fetch("${h}/paths/32.json");
const { data, meta } = await res.json();`,axios:`const { data: { data, meta } } = await axios.get(
  "${h}/paths/32.json"
